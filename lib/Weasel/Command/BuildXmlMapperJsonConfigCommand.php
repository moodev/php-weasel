...
class BuildXmlMapperJsonConfigCommand extends Command
{
    ...
    protected function setupDriver($useBuiltin)
    {
        if ($useBuiltin) {
            ...
            $driver = $factory->getXmlDriverInstance();
        } else {
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $json = $this->mapper->writeString($config, '\Weasel\XmlMarshaller\Config\ClassMarshaller[string]');
