...
{
    const _ANS = '\PhpJsonMarshaller\Config\Annotations\\';
    ...
    protected function _configureGetter(\ReflectionMethod $method) {
        $name = $method->getName();
        /**
         * @var \PhpJsonMarshaller\Config\Annotations\JsonProperty $propertyConfig
         */
    ...
    protected function _configureCreator(\ReflectionMethod $method) {
        $name = $method->getName();
        /**
         * @var \PhpJsonMarshaller\Config\Annotations\JsonCreator $creatorConfig
         */
    ...
    public function getConfig()
    {
        ...
        /**
         * @var \PhpJsonMarshaller\Config\Annotations\JsonInclude $includer
         */
        ...
        /**
         * @var \PhpJsonMarshaller\Config\Annotations\JsonTypeName $typeNamer
         */
        ...
        /**
         * @var \PhpJsonMarshaller\Config\Annotations\JsonIgnoreProperties|null $ignorer
         */
