...
class ClassAnnotationDriver
{
    ...
    protected function _configureSetter(\ReflectionMethod $method, $namespace) {
        ...
        /**
         * @var \PhpXmlMarshaller\Config\Annotations\XmlElementRef $refConfig
         */
        ...
        /**
         * @var \PhpXmlMarshaller\Config\Annotations\XmlElementRefs $refsConfig
         */
        ...
        /**
         * @var \PhpXmlMarshaller\Config\Annotations\XmlElementWrapper $wrapperConfig
         */
